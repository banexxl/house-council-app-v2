...
export const rs = {
     ...
     [tokens.notifications.tabs.announcement]: 'Najave',
     [tokens.notifications.tabs.other]: 'Ostalo',
     [tokens.notifications.col.title]: 'Naslov',
     [tokens.notifications.col.description]: 'Opis',
     ...
     [tokens.clients.unbanUser]: 'Debanuj korisnika',
     [tokens.clients.unbanUserDescription]: 'Označite korisnika kao debanovanog.',
     [tokens.clients.confirmUnbanUser]: 'Da li ste sigurni da želite da debanujete ovog korisnika?',
     [tokens.clients.userUnbanned]: 'Korisnik je debanovan!',
