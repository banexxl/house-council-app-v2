export const tokens = {
  common: {
    ...
    actionSaveFirst: 'common.actionSaveFirst',
  ...
  account: {
    security: {
      ...
      passwordStrengthWeak: 'account.security.passwordStrengthWeak',
      passwordStrengthMedium: 'account.security.passwordStrengthMedium',
      passwordStrengthStrong: 'account.security.passwordStrengthStrong',
      ...
      totpAlreadyExistsInfo: 'account.security.totpAlreadyExistsInfo',
  ...
  fileManager: {
    ...
    addFolder: 'fileManager.addFolder',
    emptyState: 'fileManager.emptyState',
    folderSummary: 'fileManager.folderSummary',
    createdAtOn: 'fileManager.createdAtOn',
    public: 'fileManager.public',
    copyLink: 'fileManager.copyLink',
    details: 'fileManager.details',
    sort: {
      latest: 'fileManager.sort.latest',
      oldest: 'fileManager.sort.oldest',
    },
    searchPlaceholder: 'fileManager.searchPlaceholder',
    uploadDialogTitle: 'fileManager.uploadDialogTitle',
    maxFileSize: 'fileManager.maxFileSize',
    storage: {
      title: 'fileManager.storage.title',
      subheader: 'fileManager.storage.subheader',
      nearLimit: 'fileManager.storage.nearLimit',
      usage: 'fileManager.storage.usage',
      upgrade: 'fileManager.storage.upgrade',
    },
    sizeLabel: 'fileManager.sizeLabel',
    createdAtLabel: 'fileManager.createdAtLabel',
    modifiedAtLabel: 'fileManager.modifiedAtLabel',
    tagsLabel: 'fileManager.tagsLabel',
    sharedWithLabel: 'fileManager.sharedWithLabel',
    renameSuccess: 'fileManager.renameSuccess',
    renameFailed: 'fileManager.renameFailed',
    deleteFolderTitle: 'fileManager.deleteFolderTitle',
    deleteFileTitle: 'fileManager.deleteFileTitle',
    deleteFolderMessage: 'fileManager.deleteFolderMessage',
    deleteFolderWithCountMessage: 'fileManager.deleteFolderWithCountMessage',
    deleteFileMessage: 'fileManager.deleteFileMessage',
    folderPathCopied: 'fileManager.folderPathCopied',
    linkCopied: 'fileManager.linkCopied',
    copyLinkFailed: 'fileManager.copyLinkFailed',
    ...
    tagsOptions: {
      ...
      business: 'fileManager.tagsOptions.business',
      planning: 'fileManager.tagsOptions.planning',
      frontend: 'fileManager.tagsOptions.frontend',
      design: 'fileManager.tagsOptions.design',
    },
  },
  polls: {
  ...
  calendar: {
    ...
    calendarUpcomingTitle: 'calendar.upcomingTitle',
    calendarUpcomingSubtitle: 'calendar.upcomingSubtitle',
    calendarViewAll: 'calendar.viewAll',
    calendarDateTbd: 'calendar.dateTbd',
    calendarPastTitle: 'calendar.pastTitle',
    calendarNoUpcoming: 'calendar.noUpcoming',
    validation: {
  ...
  subscriptionPlans: {
    ...
    // Polar-based product keys
    productName: 'subscriptionPlans.productName',
    description: 'subscriptionPlans.description',
    price: 'subscriptionPlans.price',
    billingInterval: 'subscriptionPlans.billingInterval',
    recurring: 'subscriptionPlans.recurring',
    archived: 'subscriptionPlans.archived',
    active: 'subscriptionPlans.active',
    oneTime: 'subscriptionPlans.oneTime',
    interval: {
      day: 'subscriptionPlans.interval.day',
      week: 'subscriptionPlans.interval.week',
      month: 'subscriptionPlans.interval.month',
      year: 'subscriptionPlans.interval.year',
    },
    basicInfo: 'subscriptionPlans.basicInfo',
    organizationId: 'subscriptionPlans.organizationId',
    recurringSettings: 'subscriptionPlans.recurringSettings',
    trialSettings: 'subscriptionPlans.trialSettings',
    trialInterval: 'subscriptionPlans.trialInterval',
    trialIntervalCount: 'subscriptionPlans.trialIntervalCount',
    trialIntervalCountHelper: 'subscriptionPlans.trialIntervalCountHelper',
    prices: 'subscriptionPlans.prices',
    addPrice: 'subscriptionPlans.addPrice',
    noPricesYet: 'subscriptionPlans.noPricesYet',
    priceAmount: 'subscriptionPlans.priceAmount',
    priceAmountHelper: 'subscriptionPlans.priceAmountHelper',
    priceType: 'subscriptionPlans.priceType',
  ...
  tenants: {
    ...
    // Social feed & posts
    socialFeedSeoTitle: 'tenants.socialFeedSeoTitle',
    socialFeedTitle: 'tenants.socialFeedTitle',
    socialFeedHeading: 'tenants.socialFeedHeading',
    socialFeedSearchByAuthor: 'tenants.socialFeedSearchByAuthor',
    socialFeedAddPost: 'tenants.socialFeedAddPost',
    socialFeedEmptyTitle: 'tenants.socialFeedEmptyTitle',
    socialFeedEmptyDescription: 'tenants.socialFeedEmptyDescription',
    socialFeedNoResults: 'tenants.socialFeedNoResults',
    socialFeedLoadError: 'tenants.socialFeedLoadError',
    socialFeedLoadMorePrompt: 'tenants.socialFeedLoadMorePrompt',
    socialTimelineEmptyDescription: 'tenants.socialTimelineEmptyDescription',
    socialTimelineRefreshError: 'tenants.socialTimelineRefreshError',
    socialTimeAgo: 'tenants.socialTimeAgo',
    socialPostUpdatedStatus: 'tenants.socialPostUpdatedStatus',
    socialPostAttachments: 'tenants.socialPostAttachments',
    socialPostAttachmentLabel: 'tenants.socialPostAttachmentLabel',
    socialPostAttachmentUnavailable: 'tenants.socialPostAttachmentUnavailable',
    socialPostPlaceholder: 'tenants.socialPostPlaceholder',
    socialPostActionPost: 'tenants.socialPostActionPost',
    socialPostPosting: 'tenants.socialPostPosting',
    socialPostOnlyImagesAllowed: 'tenants.socialPostOnlyImagesAllowed',
    socialPostContentRequired: 'tenants.socialPostContentRequired',
    socialPostCreateError: 'tenants.socialPostCreateError',
    socialPostCreateSuccess: 'tenants.socialPostCreateSuccess',
    socialPostUploadImagesError: 'tenants.socialPostUploadImagesError',
    socialPostUploadDocumentsError: 'tenants.socialPostUploadDocumentsError',
    socialReactionChange: 'tenants.socialReactionChange',
    socialReactionAddPost: 'tenants.socialReactionAddPost',
    socialReactionAddComment: 'tenants.socialReactionAddComment',
    socialReactionSummary: 'tenants.socialReactionSummary',
    socialReactionError: 'tenants.socialReactionError',
    socialCommentsLoading: 'tenants.socialCommentsLoading',
    socialCommentsEmpty: 'tenants.socialCommentsEmpty',
    socialCommentsLoadMore: 'tenants.socialCommentsLoadMore',
    socialCommentsLoadingMore: 'tenants.socialCommentsLoadingMore',
    socialCommentsLoadMoreError: 'tenants.socialCommentsLoadMoreError',
    socialCommentsLoadError: 'tenants.socialCommentsLoadError',
    socialCommentsAddError: 'tenants.socialCommentsAddError',
    socialCommentsMissingBuilding: 'tenants.socialCommentsMissingBuilding',
    socialShareCopyLink: 'tenants.socialShareCopyLink',
    socialShareWhatsApp: 'tenants.socialShareWhatsApp',
    socialShareViber: 'tenants.socialShareViber',
    socialShareCopySuccess: 'tenants.socialShareCopySuccess',
    socialShareCopyError: 'tenants.socialShareCopyError',
    socialMediaPreviewClose: 'tenants.socialMediaPreviewClose',
    socialMediaPreviewPrevious: 'tenants.socialMediaPreviewPrevious',
    socialMediaPreviewNext: 'tenants.socialMediaPreviewNext',
    socialMediaLoadError: 'tenants.socialMediaLoadError',
    socialMediaSelectedAlt: 'tenants.socialMediaSelectedAlt',
    socialMediaThumbnailAlt: 'tenants.socialMediaThumbnailAlt',
    socialCommentPlaceholder: 'tenants.socialCommentPlaceholder',
    socialCommentSending: 'tenants.socialCommentSending',
    socialCommentSend: 'tenants.socialCommentSend',
    socialProfileNotFoundTitle: 'tenants.socialProfileNotFoundTitle',
    socialProfileNotFoundDescription: 'tenants.socialProfileNotFoundDescription',
    socialPostArchive: 'tenants.socialPostArchive',
    socialPostArchiveSuccess: 'tenants.socialPostArchiveSuccess',
    socialPostArchiveError: 'tenants.socialPostArchiveError',
  },
  notifications: {
  ...
  email: {
    ...
    accessApprovedTitle: 'email.accessApprovedTitle',
    accessApprovedIntro: 'email.accessApprovedIntro',
    accessApprovedEmailLabel: 'email.accessApprovedEmailLabel',
    accessApprovedPasswordLabel: 'email.accessApprovedPasswordLabel',
    accessApprovedCta: 'email.accessApprovedCta',
    accessApprovedSecurityNote: 'email.accessApprovedSecurityNote',
    accessApprovedGreeting: 'email.accessApprovedGreeting',
    accessApprovedGreetingFallback: 'email.accessApprovedGreetingFallback',
    accessDeniedTitle: 'email.accessDeniedTitle',
    accessDeniedIntro: 'email.accessDeniedIntro',
    accessDeniedGreeting: 'email.accessDeniedGreeting',
    accessDeniedGreetingFallback: 'email.accessDeniedGreetingFallback',
    accessDeniedBody: 'email.accessDeniedBody',
    accessDeniedContactSupportLinkText: 'email.accessDeniedContactSupportLinkText',
    accessRequestTitle: 'email.accessRequestTitle',
    accessRequestIntro: 'email.accessRequestIntro',
    accessRequestNameLabel: 'email.accessRequestNameLabel',
    accessRequestEmailLabel: 'email.accessRequestEmailLabel',
    accessRequestBuildingLabel: 'email.accessRequestBuildingLabel',
    accessRequestApartmentLabel: 'email.accessRequestApartmentLabel',
    accessRequestMessageLabel: 'email.accessRequestMessageLabel',
    accessRequestApproveCta: 'email.accessRequestApproveCta',
    accessRequestRejectCta: 'email.accessRequestRejectCta',
    subscriptionEndingSupportTitle: 'email.subscriptionEndingSupportTitle',
    subscriptionEndingSupportIntro: 'email.subscriptionEndingSupportIntro',
    subscriptionEndingSupportDetails: 'email.subscriptionEndingSupportDetails',
    supportRegistrationSuccessTitle: 'email.supportRegistrationSuccessTitle',
    supportRegistrationSuccessIntro: 'email.supportRegistrationSuccessIntro',
    supportRegistrationClientNameLabel: 'email.supportRegistrationClientNameLabel',
    supportRegistrationClientEmailLabel: 'email.supportRegistrationClientEmailLabel',
    supportContactMessageTitle: 'email.supportContactMessageTitle',
    supportContactMessageIntro: 'email.supportContactMessageIntro',
    supportContactMessageLabel: 'email.supportContactMessageLabel',
  ...
  incident: {
    ...
    statusInProgress: 'incident.status.in_progress',
    statusOnHold: 'incident.status.on_hold',
    statusResolved: 'incident.status.resolved',
    statusClosed: 'incident.status.closed',
    statusCancelled: 'incident.status.cancelled',
    priorityLow: 'incident.priority.low',
    priorityMedium: 'incident.priority.medium',
    priorityHigh: 'incident.priority.high',
    priorityUrgent: 'incident.priority.urgent',
    categoryPlumbing: 'incident.category.plumbing',
    categoryElectrical: 'incident.category.electrical',
    categoryNoise: 'incident.category.noise',
    categoryCleaning: 'incident.category.cleaning',
    categoryCommonArea: 'incident.category.common_area',
    categoryHeating: 'incident.category.heating',
    categoryCooling: 'incident.category.cooling',
    categoryStructural: 'incident.category.structural',
    categoryInterior: 'incident.category.interior',
    categoryOutdoorSafety: 'incident.category.outdoorsafety',
    categorySecurity: 'incident.category.security',
    categoryPests: 'incident.category.pests',
    categoryAdministrative: 'incident.category.administrative',
    ...
    formApartment: 'incident.form.apartment',
    formReporter: 'incident.form.reporter',
    formAssignee: 'incident.form.assignee',
    formEmergency: 'incident.form.emergency',
    formCategory: 'incident.form.category',
    ...
    formUpdated: 'incident.form.updated',
    formCreated: 'incident.form.created',
    incidentReports: 'incident.incidentReports',
    noIncidentReports: 'incident.noIncidentReports',
    incidentReportDetails: 'incident.incidentReportDetails',
    incidentReportCreate: 'incident.incidentReportCreate',
    incidentReportEdit: 'incident.incidentReportEdit',
    listTitle: 'incident.list.title',
    listBreadcrumb: 'incident.list.breadcrumb',
    listHeroTitle: 'incident.list.heroTitle',
    listHeroSubtitle: 'incident.list.heroSubtitle',
    ...
    listFilterAll: 'incident.list.filterAll',
    overviewTitle: 'incident.overview.title',
    overviewSubtitle: 'incident.overview.subtitle',
    overviewOpen: 'incident.overview.open',
    overviewPending: 'incident.overview.pending',
    overviewInProgress: 'incident.overview.inProgress',
    overviewOnHold: 'incident.overview.onHold',
    overviewResolved: 'incident.overview.resolved',
    overviewClosed: 'incident.overview.closed',
    overviewCancelled: 'incident.overview.cancelled',
    overviewViewLink: 'incident.overview.viewLink',
    aiAnalyze: {
      notSignedIn: 'incident.aiAnalyze.notSignedIn',
      missingIncidentId: 'incident.aiAnalyze.missingIncidentId',
      notAllowedOrNotFound: 'incident.aiAnalyze.notAllowedOrNotFound',
      noImageToAnalyze: 'incident.aiAnalyze.noImageToAnalyze',
      aiUnavailable: 'incident.aiAnalyze.aiUnavailable',
      detectedIssueFallback: 'incident.aiAnalyze.detectedIssueFallback',
    },
    calendarUpcomingTitle: 'calendar.upcomingTitle',
    calendarUpcomingSubtitle: 'calendar.upcomingSubtitle',
    calendarViewAll: 'calendar.viewAll',
