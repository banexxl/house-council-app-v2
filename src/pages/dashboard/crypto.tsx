                                                            ...
                                                            >
                                                                      ...
                                                                      >
                                                                                ...
                                                                                <CryptoTransactions
                                                                                          transactions={[
                                                                                                    {
                                                                                                              _id: '3cc450e88286fdd4e220c719',
                                                                                                              amount: 0.1337,
                                                                                                              balance: 4805,
                                                                                                              coin: 'BTC',
                                                                                                              createdDateTime: subDays(subHours(subMinutes(now, 43), 5), 3).getTime(),
                                                                                                              operation: 'add',
                                                                                                              title: 'Buy BTC',
                                                                                                    },
                                                                                                    {
                                                                                                              _id: '6442793e96a90d4e584a19f7',
                                                                                                              amount: 0.2105,
                                                                                                              balance: 2344,
                                                                                                              coin: 'BTC',
                                                                                                              createdDateTime: subDays(subHours(subMinutes(now, 32), 54), 6).getTime(),
                                                                                                              operation: 'sub',
                                                                                                              title: 'Sell BTC',
                                                                                                    },
                                                                                          ]}
