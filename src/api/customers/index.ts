...
import { customerServices } from 'src/services/customers-services'
...
export const CustomersApi = () => {
          ...
          const getCustomers = (request: GetCustomersRequest = {}): GetCustomersResponse => {
                    const { filters, page, rowsPerPage, sortBy, sortDir } = request;

                    let data: any = customerServices().GetAllCustomers()
          ...
          const getCustomer = (request?: GetCustomerRequest): GetCustomerResponse => {
                    return customerServices().getCustomerById(request) as GetCustomerResponse
          }
