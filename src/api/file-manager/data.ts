...
export const items: Item[] = [
          {
                    ...
                    createdDateTime: subMinutes(now, 15).getTime(),
                    isFavorite: false,
                    isPublic: false,
                    items: [],
                    itemsCount: 12,
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 3), 4).getTime(),
                    isFavorite: false,
                    isPublic: false,
                    items: [],
                    itemsCount: 3,
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 16), 20).getTime(),
                    isFavorite: true,
                    isPublic: false,
                    itemsCount: 17,
                    name: 'invoices',
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 23), 26).getTime(),
                    isFavorite: true,
                    isPublic: true,
                    items: [],
                    itemsCount: 12,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 41), 6), 2).getTime(),
                    extension: 'pdf',
                    isFavorite: true,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 3), 14), 6).getTime(),
                    extension: 'dmg',
                    isFavorite: true,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 21), 4), 9).getTime(),
                    extension: '7z',
                    isFavorite: false,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 45), 11), 9).getTime(),
                    extension: 'msi',
                    isFavorite: false,
                    isPublic: true,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 23), 3), 10).getTime(),
                    extension: 'svg',
                    isFavorite: false,
                    isPublic: true,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 4), 2), 11).getTime(),
                    extension: 'rar',
                    isFavorite: false,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 31), 6), 11).getTime(),
                    extension: 'png',
                    isFavorite: true,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 11), 12), 11).getTime(),
                    extension: 'png',
                    isFavorite: true,
                    isPublic: true,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 4), 15), 15).getTime(),
                    extension: 'mp4',
                    isFavorite: false,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 31), 5), 17).getTime(),
                    extension: 'dmg',
                    isFavorite: false,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 11), 16), 18).getTime(),
                    extension: 'pkg',
                    isFavorite: true,
                    isPublic: false,
                    name: 'devias-kit.fig',
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 1), 3), 37).getTime(),
                    extension: 'exe',
                    isFavorite: true,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 12), 11), 40).getTime(),
                    extension: 'psd',
                    isFavorite: true,
                    isPublic: false,
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 15), 23), 41).getTime(),
                    extension: 'tar',
                    isFavorite: true,
                    isPublic: false,
                    name: 'ssl-certs.tar',
          ...
          },
          {
                    ...
                    createdDateTime: subDays(subHours(subMinutes(now, 40), 11), 62).getTime(),
                    extension: 'deb',
                    isFavorite: true,
                    isPublic: false,
