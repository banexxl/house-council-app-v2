...
type GetBuildingsResponse = Promise<{
          data: Building[];
          count: number;
}>;
                    ...
                    if (typeof filters !== 'undefined') {
                              data = data.filter((building) => {
                                        if (typeof filters.name !== 'undefined' && filters.name !== '') {
                                                  const nameMatched = building.name.toLowerCase().includes(filters.name.toLowerCase());
                                        ...
                                        if (typeof filters.category !== 'undefined' && filters.category.length > 0) {
                                                  const categoryMatched = filters.category.includes(building.category);
