...
export const threads: Thread[] = [
          {
                    ...
                    messages: [
                              ...
                              {
                                        _id: '5e867f2dba984a3f78b33526',
                                        attachments: [],
                                        body: '/assets/covers/minimal-1-4x3-small.png',
                                        contentType: 'image',
                                        createdDateTime: subHours(now, 1).getTime(),
                                        authorId: '5e86805e2bafd54f66cc95c3',
                              },
                    ],
          ...
          {
                    _id: '5e867fa7082c3c5921403a26',
                    messages: [
                              {
                                        _id: '5e867fc180837d901bd9bca1',
                                        attachments: [],
                                        body: 'Hey, would you like to collaborate?',
                                        contentType: 'text',
                                        createdDateTime: subDays(subMinutes(now, 6), 3).getTime(),
                                        authorId: '5e8680e60cba5019c5ca6fda',
                              },
                              {
                                        _id: '5e8d6fb695df7971237fc173',
                                        attachments: [],
                                        body: 'Hi, Merrile!',
                                        contentType: 'text',
                                        createdDateTime: subDays(subMinutes(now, 5), 3).getTime(),
                                        authorId: '5e86809283e28b96d2d38537',
                              },
                              {
                                        _id: '58825a290eb4d4271a54f188',
                                        attachments: [],
                                        body: 'Hello everyone 😀',
                                        contentType: 'text',
                                        createdDateTime: subDays(subMinutes(now, 2), 1).getTime(),
