...
const projects: Project[] = [
  {
    ...
    type: 'Full-Time',
    updated_at: subMinutes(now, 24).getTime(),
  },
  {
    ...
    type: 'Full-Time',
    updated_at: subHours(now, 1).getTime(),
  },
  {
    ...
    type: 'Full-Time',
    updated_at: subHours(now, 16).getTime(),
  },
];
  ...
  >
    ...
    >
      {projects.map((project) => {
        const updatedAgo = formatDistanceToNowStrict(project.updated_at);
