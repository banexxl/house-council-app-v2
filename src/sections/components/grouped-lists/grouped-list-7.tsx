...
const messages: Message[] = [
          {
                    ...
                    createdDateTime: subMinutes(now, 2).getTime(),
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 23), 3).getTime(),
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 6), 8).getTime(),
          ...
          },
          {
                    ...
                    createdDateTime: subHours(subMinutes(now, 18), 10).getTime(),
