...
export const ItemDrawer: FC<ItemDrawerProps> = (props) => {
          ...
          if (item) {
                    ...
                    const createdDateTime = item.createdDateTime && format(item.createdDateTime, 'MMM dd, yyyy HH:mm');
                    const updatedDateTime = item.updatedDateTime && format(item.updatedDateTime, 'MMM dd, yyyy HH:mm');
                    ...
                    content = (
                              <div>
                                        <Stack
                                                  ...
                                                  sx={{ p: 3 }}
                                        >
                                                  <IconButton onClick={() => onFavorite?.(item._id, !item.isFavorite)}>
                                                            <SvgIcon
                                                                      fontSize="small"
                                        ...
                                        >
                                                  ...
                                                  >
                                                            ...
                                                            <Grid
                                                                      ...
                                                                      sm={8}
                                                            >
                                                                      <Typography variant="body2">{createdDateTime}</Typography>
                                                            </Grid>
                                                            <Grid
                                                                      xs={12}
                                                                      sm={4}
                                                            ...
                                                            <Grid
                                                                      ...
                                                                      sm={8}
                                                            >
                                                                      <Typography variant="body2">{updatedDateTime}</Typography>
                                                            </Grid>
                                                            <Grid
                                                                      xs={12}
                                                                      sm={4}
                                                            ...
                                                            >
                                                                      <ItemTags
                                                                                tags={item.tags}
                                                                                onChange={(tags: string[]) => onTagsChange?.(item._id, tags)}
                                                                      />
                                                            </Grid>
                                                            <Grid
                                                                      xs={12}
