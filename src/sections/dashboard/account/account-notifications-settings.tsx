...
// import { createPolarCustomerAction, updatePolarCustomerAction } from 'src/app/actions/customer/customer-actions';
...
// export const AccountNotificationsSettings: FC<AccountNotificationsSettingsProps> = ({ customer }) => {
//      const { t } = useTranslation();
//      const [savingField, setSavingField] = useState<string | null>(null);
//      const [values, setValues] = useState({
//           has_accepted_marketing: Boolean(customer.has_accepted_marketing),
//           has_accepted_terms_and_conditions: Boolean(customer.has_accepted_terms_and_conditions),
