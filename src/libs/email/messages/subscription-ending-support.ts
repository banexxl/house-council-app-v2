export const buildSubscriptionEndingSupportHtml = (
      ...
      <table role="presentation" class="main">
        <tr>
          <td style="padding: 40px 20px; text-align: center;">
            <h1 style="font-size: 36px; font-weight: 600; margin: 0;">Subscription ${planName ?? ''} Ending Soon</h1>
            <h2 style="font-size: 18px; margin: 10px 0 20px;">Client Email: ${clientEmail}</h2>
