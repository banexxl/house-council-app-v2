...
export const TABLES = {
     ...
     // Social features for tenants
     TENANT_PROFILES: process.env.NEXT_PUBLIC_SUPABASE_TBL_TENANT_PROFILES!,
     TENANT_POSTS: process.env.NEXT_PUBLIC_SUPABASE_TBL_TENANT_POSTS!,
     TENANT_POST_IMAGES: process.env.NEXT_PUBLIC_SUPABASE_TBL_TENANT_POST_IMAGES!,
     TENANT_POST_DOCUMENTS: process.env.NEXT_PUBLIC_SUPABASE_TBL_TENANT_POST_DOCUMENTS!,
     ...
     TENANT_POST_COMMENT_IMAGES: process.env.NEXT_PUBLIC_SUPABASE_TBL_TENANT_POST_COMMENT_IMAGES!,
     ...
     // Polar tables
     POLAR_CUSTOMERS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_CUSTOMERS!,
     POLAR_CUSTOM_FIELDS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_CUSTOM_FIELDS!,
     POLAR_SUBSCRIPTIONS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_SUBSCRIPTIONS!,
     POLAR_INVOICES: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_INVOICES!,
     POLAR_PRODUCTS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCTS!,
     POLAR_PRODUCT_CUSTOM_FIELDS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCT_CUSTOM_FIELDS!,
     POLAR_PRODUCT_PRICES: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCT_PRICES!,
     POLAR_PRODUCT_BENEFITS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCT_BENEFITS!,
     POLAR_PRODUCT_MEDIAS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCT_MEDIAS!,
     POLAR_PRODUCT_ATTACHED_CUSTOM_FIELDS: process.env.NEXT_PUBLIC_SUPABASE_TBL_POLAR_PRODUCT_ATTACHED_CUSTOM_FIELDS!,
} as const;
