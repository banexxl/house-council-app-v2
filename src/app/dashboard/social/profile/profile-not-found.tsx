...
// import { createPolarCustomerAction, CustomerBuildingOption } from 'src/app/actions/customer/customer-actions';
// import { tokens } from 'src/locales/tokens';
// import { PolarCustomer } from 'src/types/polar-customer-types';

// interface ProfileNotFoundNoticeProps {
//   client: PolarCustomer | null;
//   buildings?: CustomerBuildingOption[];
// }

// export const ProfileNotFoundNotice = ({ client, buildings = [] }: ProfileNotFoundNoticeProps) => {
//   const { t } = useTranslation();
//   const router = useRouter();
//   const [selectedBuildingId, setSelectedBuildingId] = useState(buildings[0]?.id ?? '');
//   const [isSubmitting, setIsSubmitting] = useState(false);

//   const hasClientContext = Boolean(client);
...
//     const { success, error } = await createPolarCustomerAction(selectedBuildingId);
//     if (success) {
